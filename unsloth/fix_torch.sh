#!/bin/bash
# Fix PyTorch version compatibility for torchao/torch.int1
...
echo "=========================================="
echo ""
echo "This will upgrade PyTorch to 2.5.1 which supports torch.int1"
echo "required by the torchao library."
echo ""
...
echo ""
echo "Step 2: Installing PyTorch 2.5.1 with CUDA 12.1 support..."
